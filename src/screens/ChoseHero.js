...
function ChoseHero({ playGame, setPlayGame, chosenHero, setChosenHero }) {
    ...
    return (
        <>
            ...
            {showStartButton ?
                <div>
                    <button style={{ height: "75px" }} onClick={startGame}>Start Game as
                        <br />
                        <br />
                        {nameForStartButton === "battlemage_jaes" ? "BATTLEMAGE JAES" : nameForStartButton.toUpperCase()}</button>
                </div>
                : null}
            <br />
            <div style={{ display: "flex", justifyContent: "space-evenly" }}>
                <input
                    ...
                    onClick={() => choseThisHero("steelhorns")}></input>
                <input
                    style={{ height: "400px", width: "475px" }}
                    type="image"
                    id="silhouette"
