  ...
  return (
    <div id='dicePool' style={{ position: 'absolute', left: '50%', top: '50%', }}>
      <div id='attackPannel'>
        ...
        <div id='dicePic'></div>
        <div id='attackButton'>
          <button onClick={() => attack(diceRoll, selectedWeapon, offHand, selectedTarget, attackOn, attackCardsActive, showDiceRoll)}>click to attack after rollign all your dice </button>
        </div>
